...
{
    /**
     * @var int Lead ID, can be read, can't write
     */
    const ID = 'ID';
    /**
    ...
    /**
     * @var int Source identifier.  Can be read, can be write
     */
    ...
    /**
     * @var int Currency ID	Can be read, can be write
     */
    ...
    /**
     * @var int Responsible person	Can be read, can be write
     */
    const ASSIGNED_BY_ID = 'ASSIGNED_BY_ID';
    /**
     * @var int Created by	Can be read, can't write
     */
    const CREATED_BY_ID = 'CREATED_BY_ID';
    /**
     * @var int Modified by	Can be read, can't write
     */
    ...
    /**
     * @var int Company ID	Can be read, can't write
     */
    const COMPANY_ID = 'COMPANY_ID';
    /**
     * @var int Contact person’s ID	Can be read, can't write
     */
