...
class fields
{
    ...
    /**
     * @var int The current task ID. The identifier is unique across the database. Read
     */
    const ID = 'ID';
    /**
     * @var int Specifies the user ID of a person who created the task.	Read, write
     */
