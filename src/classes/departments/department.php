...
class department extends Bitrix24Entity
{
    ...
    public function get($sort, $order, $filter)
    {
        ...
        $arFilter = [Main::SORT => $sort, Main::ORDER => $order, $filterCode => $filterValue];
    ...
    {
        $result = $this->client->call('department.add', [
            Fields::NAME      => $name,
            Fields::SORT      => $sort,
    ...
    {
        $result = $this->client->call('department.update', [
            Fields::ID        => $id,
            Fields::NAME      => $name,
            Fields::SORT      => $sort,
            Fields::PARENT    => $parent,
    ...
    {
        $result = $this->client->call('department.delete', [Fields::ID => $id]);
