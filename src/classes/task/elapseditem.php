...
class elapseditem extends Bitrix24Entity
{
    ...
    {
        $result = $this->client->call('task.elapseditem.add', [$taskId, [$fields]]);
    ...
    {
        $result = $this->client->call('task.elapseditem.update', [$taskId, $elapsedItemId, [$fields]]);
    ...
    {
        $result = $this->client->call('task.elapseditem.delete', [$taskId, $elapsedItemId]);
    ...
    {
        $result = $this->client->call('task.elapseditem.isActionAllowed', [$taskId, $elapsedItemId, $actionId]);
