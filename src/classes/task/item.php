...
class item extends Bitrix24Entity
{
    ...
    {
        $result = $this->client->call('task.item.add', [$taskData]);
    ...
    {
        $result = $this->client->call('task.item.getdata', [$taskId]);
    ...
    {
        $result = $this->client->call('task.item.update', $taskId, [$taskData]);
    ...
    {
        $result = $this->client->call('task.item.delete', [$taskId]);
    ...
    {
        $result = $this->client->call('task.item.getfiles', [$taskId]);
    ...
    {
        $result = $this->client->call('task.item.getdependson', [$taskId]);
    ...
    {
        $result = $this->client->call('task.item.getallowedactions', [$taskId]);
    ...
    {
        $result = $this->client->call('task.item.getallowedtaskactionsasstrings', [$taskId]);
    ...
    {
        $result = $this->client->call('task.item.isactionallowed', [$taskId], [$actionId]);
    ...
    {
        $result = $this->client->call('task.item.delegate', [$taskId], [$userId]);
    ...
    {
        $result = $this->client->call('task.item.startexecution', [$taskId]);
    ...
    {
        $result = $this->client->call('task.item.defer', [$taskId]);
    ...
    {
        $result = $this->client->call('task.item.complete', [$taskId]);
    ...
    {
        $result = $this->client->call('task.item.renew', [$taskId]);
    ...
    {
        $result = $this->client->call('task.item.approve', [$taskId]);
    ...
    {
        $result = $this->client->call('task.item.disapprove', [$taskId]);
