...
class commentitem extends Bitrix24Entity
{
    ...
    {
        $result = $this->client->call('task.commentitem.add', [$taskId, [$fields]]);
    ...
    {
        $result = $this->client->call('task.commentitem.add', [$taskId, $commentItemId, [$fields]]);
    ...
    {
        $result = $this->client->call('task.commentitem.add', [$taskId, $commentItemId]);
    ...
    {
        $result = $this->client->call('task.commentitem.isactionallowed', [$taskId, $commentItemId, $actionId]);
