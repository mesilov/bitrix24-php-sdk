...
class checklistitem extends Bitrix24Entity
{
    ...
    {
        $result = $this->client->call('task.checklistitem.add', [$taskId, [$fields]]);
    ...
    {
        $result = $this->client->call('task.checklistitem.update', [$taskId, $checklistItemId, [$fields]]);
    ...
    {
        $result = $this->client->call('task.checklistitem.delete', [$taskId, $checklistItemId]);
    ...
    {
        $result = $this->client->call('task.checklistitem.complete', [$taskId, $checklistItemId]);
    ...
    {
        $result = $this->client->call('task.checklistitem.renew', [$taskId, $checklistItemId]);
    ...
    {
        $result = $this->client->call('task.checklistitem.moveafteritem', [$taskId, $checklistItemId, $checklistAfterItemId]);
    ...
    {
        $result = $this->client->call('task.checklistitem.isactionallowed', [$taskId, $checklistItemId, $actionId]);
